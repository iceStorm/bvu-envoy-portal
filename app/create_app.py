#  this file is required for the flask_migrate to work correctly.
#  if you delete this file, the flask_migrate will unable to detect any Model changes.
#  don't remove this file as any reasons.
...
def create_app():
    ...
    # initializing Rols-based access control
    # rbac.init_app(app)
