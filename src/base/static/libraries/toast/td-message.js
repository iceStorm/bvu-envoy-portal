(function (window, $) {
  ...
  function MessageTip(options) {
    ...
    this.pos = this.settings.position.split("-")[0];
  }
  ...
  MessageTip.prototype = {
    ...
    createElement: function (icon) {
      var that = this;
      var messageNum = $(".td-message").length;
      var htmlStr = `
      <div class="td-message-container ${this.settings.position}" >
        <div class="td-message ${this.settings.position}" data-index="${messageNum}">
          <div class="td-icon">
            ${icon}
          </div>
      ...
      var time_duration = parseInt(this.settings.duration);
      if (!(time_duration === 0)) {
        setTimeout(() => {
    ...
    showInfo: function () {
      this.createElement(this.info_icon);
    },

    showSuccess: function () {
      this.createElement(this.success_icon);
    },

    showError: function () {
      this.createElement(this.error_icon);
    },

    showWarning: function () {
      this.createElement(this.warning_icon);
    },
